// Scripts Chart.js pour la page admin EcoRide
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // Bar chart des trajets confirmés par ville
  ...
  // Camembert chart pour la répartition écologique
  new Chart(ecoSplitCtx, {
    type: 'doughnut',
    data: {
      labels: ['Électrique & hybride', 'Thermique optimisée'],
      datasets: [{
  ...
  // Line chart pour la croissance des inscriptions
  new Chart(monthlyGrowthCtx, {
    ...
    data: {
      ...
      datasets: [{
        label: 'Inscriptions',
        data: [52, 48, 55, 62, 70, 78, 85, 92, 105, 118, 130, 138],
        fill: true,
        tension: 0.35,
